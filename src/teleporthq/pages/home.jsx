    ...
    <div className={styles['container']}>
      ...
      <div className={styles['Hero']}>
        ...
        <div className={styles['container02']}>
          <h1 className={styles['text']}>Let’s keep things organised using teleportHQ</h1>
      ...
      <div className={styles['Banner']}>
        <h1 className={styles['text16']}>Learn to keep it simple</h1>
      ...
      <div className={styles['Features']}>
        <h1 className={styles['text21']}>All these impressive features</h1>
      ...
      <div className={styles['Gallery']}>
        <div className={styles['GalleryCard']}>
          <img
            alt="image"
            src="/playground_assets/avatar1510847915-0.jpeg"
            className={styles['image3']}
          />
          <h2 className={styles['text22']}>Project Title</h2>
          <span className={styles['text23']}>Lorem ipsum dolor sit amet</span>
        </div>
        <div className={styles['GalleryCard1']}>
          <img
            alt="image"
            src="/playground_assets/untitled_artwork 2.png"
            className={styles['image4']}
          />
          <h2 className={styles['text24']}>Project Title</h2>
          <span className={styles['text25']}>Lorem ipsum dolor sit amet</span>
        </div>
        <div className={styles['GalleryCard2']}>
          <img
            alt="image"
            src="/playground_assets/untitled_artwork.png"
            className={styles['image5']}
          />
          <h2 className={styles['text26']}>Project Title</h2>
          <span className={styles['text27']}>Lorem ipsum dolor sit amet</span>
        </div>
      </div>
        ...
        <div className={styles['container04']}>
          ...
          <div className={styles['container06']}>
            <div className={styles['container07']}>
              <span className={styles['text33']}>Free</span>
              <span className={styles['text34']}>$0</span>
              <span className={styles['text35']}>
                <span className={styles['text36']}>10</span>
                <span> Projects</span>
              </span>
              <span className={styles['text38']}>
                <span className={styles['text39']}>99</span>
                <span> Components</span>
              </span>
              <span className={styles['text41']}>
                <span className={styles['text42']}>3</span>
                <span> Collaborators</span>
              </span>
              <span className={styles['text44']}>
                <span className={styles['text45']}>Public projects</span>
              </span>
              <button
            ...
            <div className={styles['container08']}>
              <span className={styles['text46']}>Free</span>
              <span className={styles['text47']}>$29</span>
              <span className={styles['text48']}>
                <span className={styles['text49']}>100</span>
                <span> Projects</span>
              </span>
              <span className={styles['text51']}>
                <span className={styles['text52']}>1000</span>
                <span> Components</span>
              </span>
              <span className={styles['text54']}>
                <span className={styles['text55']}>20</span>
                <span> Collaborators</span>
              </span>
              <span className={styles['text57']}>
                <span className={styles['text58']}>Private projects</span>
              </span>
              <button
      ...
      <footer className={styles['Footer']}>
          ...
          <div className={styles['LinksContainer']}>
            <div className={styles['Container10']}>
              <div className={styles['ProductContainer']}>
                ...
                <span className={styles['text66']}>Features</span>
                <span className={styles['text67']}>Pricing</span>
                <span className={styles['text68']}>Tutorials</span>
                <span>Releases</span>
              </div>
              <div className={styles['CompanyContainer']}>
                <span className={styles['text70']}>Company</span>
                <span className={styles['text71']}>About</span>
                <span className={styles['text72']}>Careers</span>
                <span className={styles['text73']}>Contact</span>
                <span>Blog</span>
              </div>
            </div>
            <div className={styles['container11']}>
              <div className={styles['Contact']}>
                <span className={styles['text75']}>Contact Us</span>
                <span className={styles['text76']}>hello@teleporthq.io</span>
                <span>+123 (4567) 890</span>
              </div>
              <div className={styles['Socials']}>
                <span className={styles['text78']}>Follow Us</span>
        ...
        <span className={styles['text79']}>
          ...
          <span className={styles['text81']}></span>
          <span></span>
        </span>
      </footer>
    </div>
